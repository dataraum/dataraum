...
| DAT-339 pivot (Phase 0a) | (direct branch) | feat/dat-339-pivot-p0-substrate → feat/dat-339-pivot | none yet | schema-per-workspace (locked via /refine, see [dat339-pivot-status.md](./dat339-pivot-status.md)) | Phase 0a DONE — A1 (ffb9b345) + A2 (17b4fe82) + Commit B (23b0516e). Reviewer-approved. Next: Phase 0b (Drizzle two-config setup, cockpit). |
