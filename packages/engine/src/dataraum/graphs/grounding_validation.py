...
2. **Completeness** — every relation column the emitted SQL parts actually
   ...
   parse. Neither path ever *writes* a column name anywhere; a violation is
   fed back to the model for a repair turn (DAT-710 pattern) and the model
   fixes its own enumeration.
