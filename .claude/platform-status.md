...
| DAT-430 | .claude/worktrees/agent-a9cbf1a300d39e386 | feat/dat-430-import-phase-recipe-skip | #224 | none (engine import/worker seam + cockpit select tool; cockpit-mirrored Temporal contracts untouched) | gates green (engine 1502 ✓, cockpit 556 ✓), lane smoke green (real-Temporal progress test + witness round-trip), PR open — self-reviewed (no Agent tool in background lane) |
