# Calibration Handoff — Archive (2026-06-11 and earlier)

Older engine→eval handoff entries — the DAT-442 / value-layer / DAT-506 saga. Split out of
`handoff.md` on 2026-06-22 to keep the live bridge short. Read-only history; all NEW entries
go in `handoff.md`.
