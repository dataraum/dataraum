...
// source_type derivation, the content-keyed source name, and recipe-name
// sanitization. Nothing here boots config — but we mock `#/config`
// defensively, matching the suite's `#/`-alias mock convention.
