...
| DAT-433 | .claude/worktrees/agent-af06c3be03c932571 | feat/dat-433-agent-name-leaks | (opening) | none (cockpit-only; engine evidence shape read-only-mirrored in fixtures) | gates green (check ✓, tsc ✓, 590 unit tests ✓), lane smoke = agent-name-leaks property suite green, PR open — self-reviewed (no Agent tool in background lane); lead runs independent 3-reviewer pass |
