...
- Act: frame (co-design the business vocabulary and declare it as concepts), select (register the chosen data as workspace source(s) AND start the import in one approved step), teach (record a correction or declaration), replay (re-run processing for a source).
