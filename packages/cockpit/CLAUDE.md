...
│   └── metadata/
│       ├── schema.ts   # GENERATED by `pnpm db:pull:metadata` (engine's ws_<id> schema)
│       ├── relations.ts
...
- `src/db/metadata/{schema,relations}.ts` is generated — never edit by hand. Re-run `pnpm db:pull:metadata` after engine SQLAlchemy changes.
