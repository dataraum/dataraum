...
| Entropy | `entropy/db_models.py` | EntropyRecord, EntropyObjectRecord |
| Investigation | `investigation/db_models.py` | InvestigationSession, InvestigationStep |
| Pipeline | `pipeline/db_models.py` | PipelineRun, PhaseCheckpoint |
