...
snippet_search returns each snippet's concept keys (standard_field / statement / aggregation), its validated SQL (the canonical computation), and column_mappings_basis (how each concept was grounded: measure_columns, filter_columns, filter values, resolution). Match a step to a snippet by the concept keys, then:
