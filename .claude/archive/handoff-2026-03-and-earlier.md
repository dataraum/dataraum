# Calibration Handoff — archived (2026-03 and earlier)

Resolved v0.2.x-era handoffs split out of `handoff.md` (2026-05-26) to keep the live file to recent open items. These predate the DAT-339 pivot; eval/testdata have long since caught up.
